...
export const dict = {
  ...
  "zen.title": "lingke coding plan | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  ...
  "zen.faq.q1": "Czym jest lingke coding plan?",
  "zen.faq.a1":
