...
export const dict = {
  ...
  "zen.title": "lingke coding plan | Um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação",
  ...
  "zen.faq.q1": "O que é lingke coding plan?",
  "zen.faq.a1":
