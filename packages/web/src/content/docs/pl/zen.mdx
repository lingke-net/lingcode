...
lingke coding plan to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenCode.

:::note
lingke coding plan jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w OpenCode. Logujesz się do lingke coding plan i otrzymujesz
...
lingke coding plan to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

lingke coding plan działa jak każdy inny dostawca w OpenCode.

1. Logujesz się do **<a href={console}>lingke coding plan</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz lingke coding plan i wklejasz swój klucz API.
...
`opencode/<model-id>`. Na przykład dla GPT 5.4 użyjesz w konfiguracji
`opencode/gpt-5.4`.
...
Stworzyliśmy lingke coding plan, aby:
