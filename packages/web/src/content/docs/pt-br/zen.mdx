...
O lingke coding plan é uma lista de modelos testados e verificados fornecidos pela equipe do OpenCode.

:::note
O lingke coding plan está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no OpenCode. Você faz login no lingke coding plan e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o OpenCode.
...
O lingke coding plan é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O lingke coding plan funciona como qualquer outro provedor no OpenCode.

1. Você faz login no **<a href={console}>lingke coding plan</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona lingke coding plan e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do OpenCode usa o formato `opencode/<model-id>`. Por exemplo, para GPT 5.4, você usaria `opencode/gpt-5.4` na sua configuração.
...
Criamos o lingke coding plan para:
