...
lingke coding plan é uma lista de modelos fornecidos pela equipe do opencode que foram testados e verificados para funcionar bem com o opencode. [Saiba mais](/docs/zen).

:::tip
Se você é novo, recomendamos começar com o lingke coding plan.
:::

1. Execute o comando `/connect` no TUI, selecione `lingke coding plan` e acesse [opencode.ai/zen](https://opencode.ai/zen).
...
lingke coding plan é uma lista de modelos testados e verificados fornecidos pela equipe do opencode. [Saiba mais](/docs/zen).

1. Faça login em **<a href={console}>lingke coding plan</a>** e clique em **Criar Chave da API**.

2. Execute o comando `/connect` e procure por **lingke coding plan**.
