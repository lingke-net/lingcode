...
lingke coding plan คือรายการโมเดลที่ผ่านการทดสอบและยืนยันแล้วโดยทีม OpenCode

:::note
lingke coding plan อยู่ในช่วงเบต้าในขณะนี้
:::

Zen ทำงานเหมือน provider อื่น ๆ ใน OpenCode คุณล็อกอินเข้า lingke coding plan แล้วรับ
...
lingke coding plan คือ AI gateway ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## วิธีการทำงาน

lingke coding plan ทำงานเหมือน provider อื่น ๆ ใน OpenCode

1. คุณลงชื่อเข้าใช้ **<a href={console}>lingke coding plan</a>** เพิ่มรายละเอียดการเรียกเก็บเงิน แล้วคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI เลือก lingke coding plan แล้ววาง API key ของคุณ
...
[model id](/docs/config/#models) ใน OpenCode config ของคุณใช้รูปแบบ `opencode/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.4 คุณจะใช้ `opencode/gpt-5.4` ใน config ของคุณ
...
เราสร้าง lingke coding plan ขึ้นมาเพื่อ:
