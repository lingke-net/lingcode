...
lingke coding plan ist eine Liste von getesteten und verifizierten Modellen, die vom OpenCode-Team bereitgestellt wird.

:::note
lingke coding plan befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenCode. Du meldest dich bei lingke coding plan an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um OpenCode zu nutzen.
...
lingke coding plan ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

lingke coding plan funktioniert wie jeder andere Provider in OpenCode.

1. Du meldest dich bei **<a href={console}>lingke coding plan</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst lingke coding plan aus und fügst deinen API-Key ein.
...
Wir haben lingke coding plan geschaffen, um:
