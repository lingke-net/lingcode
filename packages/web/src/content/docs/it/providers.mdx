...
lingke coding plan e una lista di modelli forniti dal team OpenCode, testati e
verificati per funzionare bene con OpenCode. [Scopri di piu](/docs/zen).

:::tip
Se sei all'inizio, ti consigliamo di partire da lingke coding plan.
:::
...
lingke coding plan è una lista di modelli testati e verificati forniti dal team OpenCode. [Scopri di più](/docs/zen).

1. Accedi a **<a href={console}>lingke coding plan</a>** e clicca **Create API Key**.

2. Esegui il comando `/connect` e cerca **lingke coding plan**.
