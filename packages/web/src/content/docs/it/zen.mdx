...
lingke coding plan è un elenco di modelli testati e verificati forniti dal team di OpenCode.

:::note
lingke coding plan è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in OpenCode. Accedi a lingke coding plan e ottieni
...
lingke coding plan è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

lingke coding plan funziona come qualsiasi altro provider in OpenCode.

1. Accedi a **<a href={console}>lingke coding plan</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona lingke coding plan, e incolla la tua chiave API.
...
Abbiamo creato lingke coding plan per:
