...
lingke coding plan je lista modela koje je obezbedio OpenCode tim koji su bili
testirano i potvrđeno da dobro radi sa OpenCode. [Saznajte više](/docs/zen).

:::tip
Ako ste novi, preporučujemo da počnete sa lingke coding plan.
:::
...
lingke coding plan je lista testiranih i verifikovanih modela koju je obezbedio OpenCode tim. [Saznajte više](/docs/zen).

1. Prijavite se na **<a href={console}>lingke coding plan</a>** i kliknite na **Kreiraj API ključ**.

2. Pokrenite naredbu `/connect` i potražite **lingke coding plan**.
