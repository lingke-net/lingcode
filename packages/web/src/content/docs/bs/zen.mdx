...
lingke coding plan je lista testiranih i provjerenih modela koje pruža OpenCode tim.

:::note
lingke coding plan je trenutno u beta fazi.
:::

Zen radi kao i svaki drugi provajder u OpenCode. Prijavite se na lingke coding plan i
...
lingke coding plan je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

lingke coding plan radi kao i svaki drugi provajder u OpenCode.

1. Prijavite se na **<a href={console}>lingke coding plan</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite lingke coding plan i zalijepite svoj API ključ.
...
lingke coding plan smo napravili da:
