...
lingke coding plan is a list of tested and verified models provided by the OpenCode team.

:::note
lingke coding plan is currently in beta.
:::

Zen works like any other provider in OpenCode. You login to lingke coding plan and get
...
lingke coding plan is an AI gateway that gives you access to these models.

---

## How it works

lingke coding plan works like any other provider in OpenCode.

1. You sign in to **<a href={console}>lingke coding plan</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select lingke coding plan, and paste your API key.
...
We created lingke coding plan to:
