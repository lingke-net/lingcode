...
lingke coding plan er en liste over testede og verifiserte modeller levert av OpenCode-teamet.

:::note
lingke coding plan er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i OpenCode. Du logger inn på lingke coding plan og får
...
lingke coding plan er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

lingke coding plan fungerer som enhver annen leverandør i OpenCode.

1. Du logger inn på **<a href={console}>lingke coding plan</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger lingke coding plan og limer inn API-nøkkelen din.
...
bruker formatet `opencode/<model-id>`. For eksempel, for GPT 5.4, ville du
brukt `opencode/gpt-5.4` i konfigurasjonen din.
...
Vi opprettet lingke coding plan for å:
