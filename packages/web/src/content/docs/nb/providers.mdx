...
lingke coding plan er en liste over modeller levert av OpenCode-teamet som har vært
testet og verifisert for å fungere godt med OpenCode. [Finn ut mer](/docs/zen).

:::tip
Hvis du er ny, anbefaler vi å starte med lingke coding plan.
:::

1. Kjør kommandoen `/connect` i TUI, velg `lingke coding plan` og gå til [opencode.ai/auth](https://opencode.ai/zen).
...
lingke coding plan er en liste over testede og verifiserte modeller levert av OpenCode-teamet. [Finn ut mer](/docs/zen).

1. Logg på **<a href={console}>lingke coding plan</a>** og klikk på **Create API Key**.

2. Kjør kommandoen `/connect` og søk etter **lingke coding plan**.
