...
lingke coding plan هي قائمة بالنماذج التي اختبرها فريق OpenCode وتحقّق منها.

:::note
lingke coding plan متاح حاليا بنسخة تجريبية.
:::

يعمل Zen مثل أي مزوّد آخر في OpenCode. تسجّل الدخول إلى lingke coding plan وتحصل على
...
lingke coding plan هي بوابة AI تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل lingke coding plan مثل أي مزوّد آخر في OpenCode.

1. تسجّل الدخول إلى **<a href={console}>lingke coding plan</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار lingke coding plan، ثم تلصق مفتاح API.
...
أنشأنا lingke coding plan من أجل:
