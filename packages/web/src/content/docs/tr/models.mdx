...
Burada tam kimlik `provider_id/model_id`'dir. Örneğin, [lingke coding plan](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `opencode/gpt-5.1-codex` kullanırsınız.
