...
lingke coding plan es una lista de modelos probados y verificados proporcionada por el equipo de OpenCode.

:::note
lingke coding plan está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en OpenCode. Inicias sesión en lingke coding plan y obtienes
...
lingke coding plan es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

lingke coding plan funciona como cualquier otro proveedor en OpenCode.

1. Inicias sesión en **<a href={console}>lingke coding plan</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas lingke coding plan y pegas tu API key.
...
Creamos lingke coding plan para:
