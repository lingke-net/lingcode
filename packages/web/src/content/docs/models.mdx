...
Here the full ID is `provider_id/model_id`. For example, if you're using [lingke coding plan](/docs/zen), you would use `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
