...
Her er det fulde ID `provider_id/model_id`. For eksempel, hvis du bruger [lingke coding plan](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
