...
lingke coding plan er en liste over testede og verificerede modeller leveret af OpenCode-teamet.

:::note
lingke coding plan er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i OpenCode. Du logger ind på lingke coding plan og får
...
lingke coding plan er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

lingke coding plan fungerer som enhver anden udbyder i OpenCode.

1. Du logger ind på **<a href={console}>lingke coding plan</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger lingke coding plan og indsætter din API-nøgle.
...
Vi skabte lingke coding plan for at:
