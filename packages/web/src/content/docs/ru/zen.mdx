...
lingke coding plan — это список протестированных и проверенных моделей, предоставленный командой OpenCode.

:::note
lingke coding plan сейчас находится в бета-версии.
:::

Zen работает как любой другой провайдер в OpenCode. Вы входите в lingke coding plan и получаете
...
lingke coding plan — это AI-шлюз, который дает вам доступ к этим моделям.

---

## Как это работает

lingke coding plan работает как любой другой провайдер в OpenCode.

1. Вы входите в **<a href={console}>lingke coding plan</a>**, добавляете платежные
   данные и копируете свой ключ API.
2. Вы запускаете команду `/connect` в TUI, выбираете lingke coding plan и вставляете свой ключ API.
...
Мы создали lingke coding plan, чтобы:
